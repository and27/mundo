    ...
    <div className="space-y-4">
      <div className="relative">
        <textarea
          ...
          className="w-full bg-white/80 border border-slate-300 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-200 rounded-lg p-3 text-slate-800 placeholder:text-slate-500 transition-all duration-200 resize-none"
          disabled={disabled}
          maxLength={maxChars}
          style={{
            minHeight: minHeight,
